...
ALTER TABLE queries ADD COLUMN tags JSONB NOT NULL DEFAULT '[]';
ALTER TABLE visualizations ADD COLUMN tags JSONB NOT NULL DEFAULT '[]';
ALTER TABLE dashboards ADD COLUMN tags JSONB NOT NULL DEFAULT '[]';
ALTER TABLE schedules ADD COLUMN tags JSONB NOT NULL DEFAULT '[]';
